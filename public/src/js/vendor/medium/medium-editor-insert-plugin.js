...
(function (factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        module.exports = function (jQuery) {
            ...
            Handlebars = require('vendor/medium/handlebars.runtime');
            MediumEditor = require('vendor/medium/medium-editor');
            require('vendor/medium/jquery-sortable-min');
            require('vendor/bluimp-upload/jquery.fileupload-ui');
